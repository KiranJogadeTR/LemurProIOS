...
'searching for objects in search box'
...
Mobile.verifyElementExist(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/Deletebuttonofattributeview'), 
    10)
'wait for editicon of attribute view'
...
Mobile.verifyElementExist(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/XCUIElementTypeStaticText - DataEntryTest Corrections'), 
    10)
'wait for test text element present'
...
Mobile.verifyElementExist(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/savebuttonofworkorder'), 
    10)
'wait for delete button of attribute'
Mobile.waitForElementPresent(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/Deletebuttonofattributeview'), 30)
'verify the delete button '
Mobile.verifyElementExist(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/Deletebuttonofattributeview'), 
    10)
...
Mobile.tap(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/plusiconoftestinteger'), 
    10)
'wait for  No value text  feild icon'
Mobile.waitForElementPresent(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/No Valuetextfield'), 30)
'entering the text in the No value text feild'
Mobile.sendKeys(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/No Valuetextfield'), 
    'line')
...
'wait for element present'
Mobile.waitForElementPresent(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/Deletebuttonofattributeview'), 30)
'click on the delete  icon of the object '
Mobile.tap(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/Deletebuttonofattributeview'), 
    10)
'wait for popup present'
Mobile.waitForElementPresent(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/deleteworkorder/XCUIElementTypeTextView - Are you sure you wish to delete the selected object'), 30)
'click on the no button of confiramation popup'
Mobile.tap(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/deleteworkorder/nobuttonofconfirmationdelete'), 
    10)
'wait for element present'
Mobile.waitForElementPresent(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/Deletebuttonofattributeview'), 30)
'again click on the delete icon to delete workorder'
Mobile.tap(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/Addworkordercorrection/Deletebuttonofattributeview'), 
    10)

'wait for element present'
Mobile.waitForElementPresent(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/deleteworkorder/yes icon of confirmation delete'), 30)
'click on the yes button of delete confirmation popup'
Mobile.tap(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/deleteworkorder/yes icon of confirmation delete'), 
    10)
'wait for element present'
...
'click on the close button of right menu work order'
Mobile.tap(findTestObject('Object Repository/Lemurpro2024R2checklistTacomacorrectionbundle/deleteworkorder/closebuttonofrightmanuworkorder'), 
    10)
